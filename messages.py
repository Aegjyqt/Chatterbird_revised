...
about = "Chatterbot was designed to supplement the Translator service in ITMO's ISU system.\n" \
        ...
        "On the bright side, it does its best at working with declensions, so that you can copy terms from " \
        "whatever text you're working with, and get a translation in a single click"
